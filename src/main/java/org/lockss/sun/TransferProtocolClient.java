...
/*
 * Identical to Java sun.net.TransferProtocolClient except for the package
 *
 * Temporarily incorporated into lockss-core until we can complete the
 * javax -> jakarta transition, allowing us to replace SmtpClient with
 * one based on jakarta.mail.
 */

package org.lockss.sun;
